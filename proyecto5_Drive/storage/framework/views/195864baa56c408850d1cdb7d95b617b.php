<article class="media">
    <div class="media-content">
        <div class="content">
            ...
            <form method="POST" action="<?php echo e(route('comment.delete', ['comment' => $comment->id])); ?>" style="display:inline;">
                <?php echo csrf_field(); ?>
            ...
            <button 
                ...
                data-comment-author="<?php echo e($comment->user->name); ?>">
...
<?php /**PATH /var/www/html/resources/views/partials/comment.blade.php ENDPATH**/ ?>